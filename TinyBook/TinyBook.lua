...
TSB_MAX_SKILLLINE_TABS = 8; -- Same number as Blizzard's book, but replicated here to protect against changes. Is GLOBAL to allow third-party access!
TSB_SPELLS_PER_PAGE = 12; -- Same number as Blizzard's book, but replicated here to protect against changes. Is GLOBAL to allow third-party access!
